...
export const BentoEnvironmentalConcerns = ({
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 left-0 w-full h-full bg-tealAccent/10 bg-gradient-to-br from-gray-900/20 via-gray-800/20 to-gray-700/20"
      />
      ...
      <div className="w-full h-full relative z-10 mt-12 ">
        ...
        <div className="bg-red-950/50 border-l-4 border-tealAccent p-4 mb-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-red-950/30 p-3 rounded-lg">
            <div className="flex items-center space-x-3">
              <div className="bg-red-950/30 p-2 rounded-lg">
                <Heart className="w-6 h-6 text-tealAccent" />
              </div>
          ...
          <div className="bg-red-950/30 p-3 rounded-lg">
            <div className="flex items-center space-x-3">
              <div className="bg-red-950/30 p-2 rounded-lg">
                <Mountain className="w-6 h-6 text-tealAccent" />
              </div>
          ...
          <div className="bg-red-950/30 p-3 rounded-lg">
            <div className="flex items-center space-x-3">
              <div className="bg-red-950/30 p-2 rounded-lg">
                <AlertTriangle className="w-6 h-6 text-tealAccent" />
              </div>
          ...
          <div className="bg-red-950/30 p-3 rounded-lg">
            <div className="flex items-center space-x-3">
              <div className="bg-red-950/30 p-2 rounded-lg">
                <Droplets className="w-6 h-6 text-tealAccent" />
              </div>
...
export function BentoEnvironment({ className }: { className?: string }) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      whileHover="hover"
      className={`col-span-1 row-span-1 relative overflow-hidden rounded-3xl bg-gradient-to-br from-mintAccent/20 via-tealAccent to-mintAccent/5 p-6 ${className}`}
    >
