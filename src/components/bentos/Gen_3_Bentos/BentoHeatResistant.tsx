...
export function BentoHeatResistant({ className }: { className?: string }) {
  return (
    <motion.div 
      ...
      variants={{
        hover: {
          backgroundImage: "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQr8F55gwEIHfUQh1eKKjH9C7xLwCUEskJ5yH4x4hGApg7JX1PdDqt2LU1W7fhAT1O_Mvs&usqp=CAU')",
    ...
    >
      <div className="space-y-0 relative z-10">
        ...
        variants={{
          hover: { color: "rgba(248,248,248,1)" }
        }}
