...
// Replace the direct import with dynamic import and delay
const SerenityShader = dynamic<any>(
  () =>
    import("../backgroundAnimations/SerenityShader").then(
      (mod) =>
        new Promise((resolve) => setTimeout(() => resolve(mod.default), 500))
    ),
  {
    ssr: false,
...
export const HeroSection5wDelay = ({
  className,
  debug = false,
}: HeroSection5Props) => {
