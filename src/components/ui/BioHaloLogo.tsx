...
export function BioHaloLogo({
  ...
  const pathStyles = {
    strokeWidth: finalStyles.strokewidth,
    strokeDasharray: finalStyles.strokedasharray,
    strokeDashoffset: finalStyles.strokedashoffset,
  };
