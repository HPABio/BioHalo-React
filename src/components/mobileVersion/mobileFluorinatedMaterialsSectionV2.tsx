...
export function MobileFluorinatedMaterialsSectionV2({
  stats,
  className = "",
  debug = false,
        ...
        bg-gradient-to-b from-black via-black to-transparent">
          <div className="relative w-full h-full max-w-[1280px] flex flex-col mx-auto px-6">
            ...
            <div className="w-full flex flex-col items-center">
              ...
              Perfluoroalkyl and <br className="block md:hidden" /> polyfluoroalkyl substances
                  <br />
                </span>
              <span className="text-xl text-gray-500 font-poppins font-light leading-snug">
                ...
                {/* <span className="bg-gradient-to-r text-3xl from-pink-950 via-pinkAccent to-pink-950 bg-clip-text text-transparent box-decoration-clone leading-none">
                  Forever Chemicals
                </span>
                " */}
                <br />
                <span className="text-xl text-gray-500 font-poppins font-light leading-none">
                  {" "}
                  play a crucial role in virtually
                  every major sector of our modern economy. They are used in...
                </span>
              </h1>
            </div>
...
<div className="w-full relative pt-32 mb-32 border-2 border-red-500/0">
  ...
  style={{
    background: `url(${IndustrialMachineCloseUpLummiAi.src})`,
    ...
    filter: useTransform(
      ...
      [0, 0.3, 0.5, 1],
      ["brightness(1) saturate(0.7)", "brightness(2) saturate(1.2)", "brightness(3) saturate(1)", "brightness(0.8) saturate(0.7)"]
    )
  }}
    className="w-[75%] aspect-square rounded-full overflow-visible relative left-0 mr-auto ml-0
     border-2 border-tealAccent translate-x-[5%] z-0 "
  >
    <div
  ...
  style={{
    filter: useTransform(
      ...
      [0, 0.2, 0.4, 1],
      ["brightness(1)", "brightness(1.5)", "brightness(2.5)", "brightness(1)"]
    )
  }} 
  
  className="w-fit h-fit flex items-center justify-center absolute bottom-0 left-0 translate-y-[125%] translate-x-[10%]">
    <p
      className="text-sm text-slate-300/50 font-black font-poppins text-right"
  ...
  <div className="w-full h-fit absolute top-[70%] right-0 border-2 border-red-500/0">
    <div
      className="w-[55%] aspect-square rounded-full overflow-hidden relative ml-auto mr-0 mix-blend-screen
    translate-x-[19%] translate-y-[-10%] rotate-[-25deg]"
      style={{
        filter: "saturate(0.7) brightness(0.8)",
        background: `url(${TeflonMaterialUnsplash.src})`,
        backgroundSize: "100%",
        backgroundPosition: "center",
        backgroundRepeat: "no-repeat",
      }}
    >
      ...
      />
      <div
        className="w-[30%] h-full absolute left-0 top-0 rotate-[20deg] translate-y-[-10%]
      bg-gradient-to-l from-transparent via-black/50 to-black"
      />
    </div>
  </div>
</div>
              
              {/* animation on whileInView for Mobile */}
              <div className="w-full h-fit relative pt-10">
                <motion.div
                  ...
                  className="w-[90%] aspect-square rounded-full overflow-visible relative mr-auto ml-0 "
                >
                  <div
                    className="absolute inset-0"
                    style={{
                ...
                <motion.div 
                  ...
                  style={{
                    filter: useTransform(
                      ...
                      [0, 0.4, 0.5, 1],
                      ["brightness(1)", "brightness(3)", "brightness(2)", "brightness(1)"]
                    )
                  }}
                  className="w-fit h-fit flex items-center justify-center absolute bottom-0 right-0 translate-y-[80%]
                  border-2 border-red-500/0">
                  <p
                    className="text-sm text-slate-300/50 font-medium font-poppins leading-none">
                    <span
                      className="text-3xl text-tealAccent uppercase font-semibold font-poppins leading-none">
                      electronics
                    <br />
                    </span>
                    production of
              ...
              <div className="w-full relative pt-32 mb-32 border-2 border-red-500/0">
                ...
                <div className="w-full h-fit absolute top-[70%] right-0 border-2 border-red-500/0">
                  ...
                  translate-x-[19%] translate-y-[-10%] rotate-[-25deg]"
                    style={{
                      filter: "saturate(0.7) brightness(0.8)",
                      background: `url(${FuturisticRocketEngineLummiAi.src})`,
                      backgroundSize: "100%",
                      backgroundPosition: "center",
                      backgroundRepeat: "no-repeat",
                    }}
              ...
              <div className="w-full h-fit relative flex flex-col items-center justify-center border-2 border-red-500">
                <div
                  className="w-[300px] aspect-square flex flex-row items-start justify-center gap-16 relative overflow-hidden
                  border-2 border-lightGrey/30 rounded-full bg-black bg-gradient-to-t from-black via-slate-900/20 to-slate-900/50"
                >
                  <motion.div
                    ref={refBottle}
                    className="w-full aspect-square rounded-full overflow-hidden relative border-2 border-yellow-500"
                    initial={{
                      rotate: -30,
                      scale: 0.7,
                      opacity: 0,
                ...
                <div className="w-fit h-fit flex items-center justify-center absolute bottom-0 left-0 translate-y-[125%] translate-x-[10%]">
                  <p
                    className="text-sm text-slate-300/50 font-black font-poppins text-right"
                    style={{ lineHeight: "1.3" }}
                  >
