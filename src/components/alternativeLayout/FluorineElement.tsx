    ...
    <div className={`flex flex-col item justify-center ${className}`}>
      ...
      <div className="w-full h-[300px] md:h-[400px] flex flex-col items-center justify-center">
        ...
        <div className="relative flex flex-col items-center justify-center">
          <AtomDiagram className="absolute h-full w-full top-[-50%] left-[50%] translate-x-[-50%] translate-y-[50%] scale-[2] md:scale-[3] opacity-20" />
          <div className="relative aspect-square w-28 md:w-40 border-[2px] md:border-[8px] border-gray-600 drop-shadow-2xl rounded-xl flex flex-col items-center justify-center bg-gradient-to-br from-pink-800/10 to-purple-900/10 backdrop-blur-md text-gray-600 hover:scale-105 transition-transform duration-300">
            ...
            <span className="absolute top-2 left-3 text-[min(4vw,0.75rem)] md:text-[min(6vw,0.875rem)] font-bold">
              9
            </span>
