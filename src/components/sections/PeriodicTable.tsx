...
function ElementTile({ element }: { element: Element }) {
  ...
  const textColor = isFluorine
    ? FLUORINE_TEXT
    : isHalogen
    ? HALOGEN_TEXT
    : "#333333";
  const numberColor = isFluorine
    ? FLUORINE_TEXT
    : isHalogen
    ? HALOGEN_TEXT
    : "#CCCCCC";
        ...
        >
          <div className="space-y-1.5">
            ...
            <p className="text-[clamp(11px,1.1vw,13px)] text-gray-600">
              A highly reactive halogen element that plays a crucial role in
              modern chemistry. It's the most electronegative element and forms
              strong bonds with most elements.
            </p>
