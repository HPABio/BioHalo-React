...
import MobileNetworkDiagramWithNodes from "@/components/production/mobileVersion/mobileNetworkDiagramWithNodes";
      ...
      <div className="max-w-7xl mx-auto px-12 -mt-32">
        ...
        >
          ...
          <div className="absolute inset-0 -z-10 overflow-hidden">
            ...
            <div className="absolute bottom-1/3 left-1/4 w-40 h-40 bg-tealAccent/5 rounded-full blur-xl"></div>
          </div>
