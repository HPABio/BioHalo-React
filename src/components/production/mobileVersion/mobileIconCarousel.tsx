...
export default function MobileIconCarousel({ className }: { className?: string }) {
  ...
  return (
    <div className={`${className} flex items-center justify-center relative`}>
      <div className="w-[1200px] h-[1200px] flex items-center justify-center">
        ...
        translate-y-[-100px] mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-2xl text-gray-300 mx-auto p-6 rounded-xl 
            bg-gradient-to-br from-gray-900/60 to-gray-800/60 border border-tealAccent/10 backdrop-blur-sm"
          >
